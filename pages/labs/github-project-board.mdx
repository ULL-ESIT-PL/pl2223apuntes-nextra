...
* Para cada práctica/asignación se creará un tablero kanban (GitHub Project Automated Kanban) asociado al repo de la práctica
  ...
  ![github-project-board-example.png](/github-project-board-example.png)
...
![organization-project-board-beta.png](/organization-project-board-beta.png)
...
## Rubric as a Component

import {Rubric} from '@components/rubric'

<Rubric list={ frontMatter.rubrica }></Rubric>